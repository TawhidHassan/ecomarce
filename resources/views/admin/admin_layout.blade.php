...
<body>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="{{URL::to('/admin_logout')}}"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="{{URL::to('/dasbord')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>
						...
						<li>
							...
							<ul>
								<li><a class="submenu" style="background: black;" href="{{URL::to('/addproducts')}}"><i class="icon-file-alt"></i><span class="hidden-tablet" style="background: black;">Add Product</span></a></li>

								<li><a class="submenu" style="background: black;" href="{{URL::to('/allproducts')}}"><i class="icon-file-alt"></i><span class="hidden-tablet" style="background: black;">All Product</span></a></li>
							</ul>	
						</li>

                         <li>
							<a class="dropmenu" href="#"><i class="icon-edit"></i><span class="hidden-tablet"><span class="hidden-tablet">Slider</span><span class="label label-important"> New </span></a>
							<ul>
								<li><a class="submenu" style="background: black;" href="{{URL::to('/addslider')}}"><i class="icon-file-alt"></i><span class="hidden-tablet" style="background: black;">Add Slider</span></a></li>

								<li><a class="submenu" style="background: black;" href="{{URL::to('/allslider')}}"><i class="icon-file-alt"></i><span class="hidden-tablet" style="background: black;">All Slider</span></a></li>
							</ul>	
						</li>
						...
						<li><a href="gallery.html"><i class="icon-picture"></i><span class="hidden-tablet">Dalavary-Man PRF</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
			...
			<!-- start: Content -->
			<div id="content" class="span10"><!--/row-->
			
       @yield('dasbord_content')
  ...
  <script>
        $(document).on("click","#delet", function(e) {
          ...
          var link=$(this).attr("href");
            bootbox.confirm("Are you want to delet!!", function(confirmed) {
              if(confirmed){
